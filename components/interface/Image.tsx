...
// TODO: Figure out how to use next/image with static export.
// Can we get the static export to generate and use WebP files?
// import NextImage from 'next/image';
// In the meantime, use next-optimized-images
 ...
 * @param block If true, the value will be null until the value is determined.
 *   Else, the value will be the default extension.
 */
export const useImageExtension = (block = false): string => {
 ...
 * @deprecated Use react-optimized-image/Img instead.
 */
