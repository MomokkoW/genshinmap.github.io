...
/**
 * Generates a Github Crash Report Issue submission link from the parameters.
 *
 * NOT PURE: Fetches current user preferences when called, to include in the error report.
 * @param name The error name.
 * @param message The error extended message.
 * @param stackTrace The error stack trace (sourcemapped).
 * @returns The URL to direct the user to.
 */
